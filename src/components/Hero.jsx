      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="flex gap-6 justify-center lg:justify-start">
            <a href="https://github.com/CodeAreeba" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-800/40 rounded-lg text-gray-400 hover:text-white transition-all hover:scale-110">
            ...
            <a href="https://linkedin.com/in/areeba-abdullah-b0466a26a" target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-800/40 rounded-lg text-gray-400 hover:text-white transition-all hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="https://www.facebook.com/share/17nvVqYV25/" className="p-3 bg-gray-800/40 rounded-lg text-gray-400 hover:text-white transition-all hover:scale-110">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 sm:pt-6">
            <a 
              href="#contact" 
              className="px-8 py-3.5 sm:px-10 sm:py-4 border border-gray-700 hover:border-[#00D1B2] text-white font-medium rounded-full transition-all group flex items-center justify-center gap-2 text-sm sm:text-base"
            >
