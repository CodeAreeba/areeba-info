    ...
    <section id="contact" className="w-full py-20 px-6 lg:px-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-12 lg:gap-24 items-start w-full relative">
          ...
          <div className="w-full lg:w-auto space-y-10 lg:pl-0">
            ...
            <SectionReveal delay={0.5}>
              <div className="flex flex-wrap gap-4 pt-10">
                <a href="#" className="w-10 h-10 bg-gray-800/60 border border-gray-600/50 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#00D1B2] hover:border-[#00D1B2] transition-all duration-300 hover:scale-110 shadow-lg">
                ...
                <a href="#" className="w-10 h-10 bg-gray-800/60 border border-gray-600/50 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] transition-all duration-300 hover:scale-110 shadow-lg">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
